  ...
  return (
    <div className="mt-8">
      <div className="flex w-full flex-col items-center gap-8">
        {/* NAME */}
        <Card className="w-full pb-0! md:w-2xl">
          <CardHeader>
          ...
          <CardFooter className="bg-muted flex items-center justify-between rounded-b-lg py-2">
            <p className="text-muted-foreground text-sm">
              Please use 32 characteres maximum
            </p>
            <Button
              size="sm"
        ...
        {/* PASSWORD */}
        <Card className="w-full pb-px! md:w-2xl">
          <CardHeader>
        ...
        {/* DELETE ACCOUNT */}
        <Card className="border-destructive w-full pb-0! md:w-2xl">
          <CardHeader>
